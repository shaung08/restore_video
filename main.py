...
from restore_video.utils.convert_framerate import Video
from restore_video.mmedit.apis import init_model, restoration_video_inference
from restore_video.mmedit.utils import tensor2img

tmp_video01, tmp_video02 = "tmp01.mp4", "tmp02.mp4"
...
def main():
    ...
    args = parse_args()
    video_ = Video(args.input, args.output, tmp_video01, fps)
